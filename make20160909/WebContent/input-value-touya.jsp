...
<table>
	...
	<tr>
		<td>チェックボックス</td>
		<td>
			<input type="checkbox" id="c1" name="sports" value="1"><label for="c1">Basketball</label>
			<input type="checkbox" id="c2" name="sports" value="2"><label for="c2">Baseball</label>
			<input type="checkbox" id="c3" name="sports" value="3"><label for="c3">Football</label>
		</td>
	</tr>
	<tr>
		<td>ラジオボタン</td>
	...
	<tr>
		...
		<td><input type="date" name="date" value ="theDate"/></td>
	</tr>
	<tr>
